<template>
    <div class="v-vomiting-cats">
        <div class="container">
            <div class="v-vomiting-cats-block">
                <div class="v-vomiting-cats-left">
                <img src="@/assets/images/vetarticles/kot-23.png" class="card-img-top" alt="kot-23">
                <h1 class="v-vomiting-cats-title">Рвота у кошек </h1>
                <div class="v-vomiting-cats-subtitle">
                    Рвота у кошек — достаточно распространенное явление, вызываемое различными факторами. Рефлекторное извержение содержимого желудка через рот — не болезнь, а симптом, указывающий на нарушение в работе органов пищеварения или других систем. Рвота иногда опасна для здоровья и жизни питомца, особенно если она длится долго, сопровождается другими симптомами или приводит к обезвоживанию. Выяснить, почему рвет кота, осмотр у ветеринара и детальная диагностика.
                </div> 
                <h1 class="v-vomiting-cats-title">Что такое тошнота и рвота </h1>
                <div class="v-vomiting-cats-subtitle">
                    Тошнота у кошки — неприятное ощущение в области желудка, часто предшествует рвоте. Рвота — сложный рефлекторный процесс, контролируемый рвотным центром, который находится в продолговатом мозге. Его возбуждение происходит по разным причинам:
                    <ul>
                    ...
                    Защитная реакция организма бывает острой или хронической, рвотные массы могут отличаться по цвету и консистенции, сопровождаться дополнительными симптомами. Рвота возникает по разным причинам и их выявление является залогом успешной терапии. Неправильное лечение зачастую приводит к ухудшению состояния животного и даже к летальному исходу.
                </div> 
                <h1 class="v-vomiting-cats-title">Возможные причины рвоты у котов и кошек</h1>
                <div class="v-vomiting-cats-subtitle">
                    Рвота у кота может быть вызвана разными факторами, которые условно делятся на две группы. Физиологические причины связаны с особенностями питания и поведения животных. К ним относятся:
                    <ul>
                    ...
                    Патологические причины тошноты у кошки связаны с развитием различных заболеваний, поражающих органы пищеварения или другие системы:
                ...
                <h1 class="v-vomiting-cats-title">Другие симптомы при рвоте у котов и кошек</h1>
                <div class="v-vomiting-cats-subtitle">При патологических процессах рвота у животного дополняется другими проявлениями:              
                    <ul>
                        <li>слезотечение;</li>
                        <li>сильная жажда;</li>
                        <li>понос;</li>
                ...
                <h1 class="v-vomiting-cats-title">Осложнения рвоты у котов</h1>
                <div class="v-vomiting-cats-subtitle">Чем опасна длительная рвота у кошки? Она приводит к различным осложнениям, угрожающим здоровью и жизни животного. К ним относятся:             
                    <ul>
                ...
                <h1 class="v-vomiting-cats-title">Что дать кошке от рвоты в домашних условиях</h1>
                <div class="v-vomiting-cats-subtitle">Если питомца рвет, то, в первую очередь, необходимо оценить его состояние и определить причину рвоты. Если она однократная, не сопровождается другими симптомами и связана с физиологическими причинами, то попробуйте помочь коту в домашних условиях.
                ...
                <h1 class="v-vomiting-cats-title">Диагностика</h1>
                <div class="v-vomiting-cats-subtitle">Чтобы установить точную причину рвоты у кошки, необходимо провести диагностику, которая включает следующие методы:             
                    <ul>
                ...
                <h1 class="v-vomiting-cats-title">Лечение тошноты и рвоты у кошек</h1>
                <div class="v-vomiting-cats-subtitle">Лечение рвоты у кошек зависит от причины, тяжести состояния и наличия осложнений. Оно бывает быть консервативным или хирургическим, амбулаторным или стационарным. Включает следующие мероприятия:             
                 <ul>
                ...
                <h1 class="v-vomiting-cats-title">Как кормить питомца при рвоте</h1>
                <div class="v-vomiting-cats-subtitle">Как остановить рвоту у кота? В первую очередь стоит обратить внимание на питание, чтобы не усугубить состояние животного и способствовать его восстановлению. Вот несколько рекомендаций, как кормить питомца:        
                    <ul>
                ...
                <h1 class="v-vomiting-cats-title">Рвота у котёнка</h1>
                <div class="v-vomiting-cats-subtitle">Рвота у котенка особенно опасна, так как малыши более уязвимы к обезвоживанию, инфекциям, отравлениям и другим факторам, которые могут ее спровоцировать. Основные причины, почему у кота рвота                         
                    <ul>
                ...
                <h1 class="v-vomiting-cats-title">Профилактика</h1>
                <div class="v-vomiting-cats-subtitle">Профилактика рвоты у кошек заключается в соблюдении ряда мер, которые помогут предотвратить или уменьшить риск ее возникновения у питомца. К ним относятся:            
                 <ul>
...
<style scoped lang="scss">
    .v-vomiting-cats-block{
        display: flex;
    }
    .v-vomiting-cats-left{
        margin-right: 20px;
        margin-left: 0;
        flex: 0 0 70%;
        max-width: 70%;
