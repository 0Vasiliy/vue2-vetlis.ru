    ...
    <div class="v-vomiting-dogs">
        <div class="container">
            <div class="v-vomiting-dogs-left">
                ...
                <h1 class="v-vomiting-dogs-title">Что такое тошнота и рвота</h1>
                <div class="v-vomiting-dogs-subtitle">Тошнота и рвота у собак — процессы, связанные с избавлением организма от содержимого желудка через рот.
                ...
                <h1 class="v-vomiting-dogs-title">Возможные причины рвоты у собак</h1>
                <div class="v-vomiting-dogs-subtitle">Тошнота и рвота не являются самостоятельными заболеваниями, это признаки сбоя в работе организма. Спровоцировать их могут разные факторы:
                    <ul>
                ...
                <h1 class="v-vomiting-dogs-title">Виды рвоты у собак</h1>
                <div class="v-vomiting-dogs-subtitle">Рвота у собак отличается по характеру, частоте, времени, объему и составу. В зависимости от этих параметров выделяют следующие виды:
                    <ul>
                ...
                <h1 class="v-vomiting-dogs-title">Другие симптомы при рвоте у собак</h1>
                <div class="v-vomiting-dogs-subtitle">При патологических процессах у животного кроме рвоты будут и иные проявления. Например, для панкреатита характерны сильные боли, которые очень сильно пугают владельца. Ведь питомец начинает скулить, выгибать спину, падать на передние лапы.
                ...
                <h1 class="v-vomiting-dogs-title">Осложнения рвоты у собак</h1>
                <div class="v-vomiting-dogs-subtitle">Рвота приводит к различным осложнениям, угрожающим жизни животного:
                   <ul>
                ...
                <h1 class="v-vomiting-dogs-title">Что дать собаке от рвоты в домашних условиях</h1>
                <div class="v-vomiting-dogs-subtitle">Если рвота не сопровождается другими тревожными симптомами, и вы уверены, что она не связана с серьезным заболеванием, то попробуйте помочь питомцу в домашних условиях.
                ...
                <h1 class="v-vomiting-dogs-title">Диагностика</h1>
                <div class="v-vomiting-dogs-subtitle">
                    Для выявления причины, почему собака блюет, ветеринарный врач проведет осмотр животного, соберет анамнез и назначит необходимые исследования. В зависимости от подозреваемого диагноза требуются следующие исследования:
                    <ul>
                ...
                <h1 class="v-vomiting-dogs-title">Лечение тошноты и рвоты у собак</h1>
                <div class="v-vomiting-dogs-subtitle">
                    Лечение рвоты у собаки зависит от причины, которая вызвала рвоту. Только ветеринарный врач может поставить точный диагноз и назначить адекватную терапию. В общем случае, используются следующие терапевтические методы:
                    <ul>
                ...
                <h1 class="v-vomiting-dogs-title">Как кормить питомца при рвоте</h1>
                <div class="v-vomiting-dogs-subtitle">
                    Питание собаки при рвоте должно быть легкоусвояемым, нежирным, некислым и неострым. Кормить нужно часто, но маленькими порциями, чтобы не перегружать желудок и кишечник. Рацион животного рекомендуется согласовать с ветеринаром, который подберет оптимальный вариант в зависимости от причины рвоты и состояния собаки.
                ...
                <h1 class="v-vomiting-dogs-title">Профилактика</h1>
                <div class="v-vomiting-dogs-subtitle">Чтобы предотвратить рвоту у собаки, необходимо соблюдать следующие меры профилактики:
                   <ul>
